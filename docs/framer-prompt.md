...
2. **HeroSection**, 64px top padding.
   ...
   Lede, text-body-lg, Text/Secondary, max 580px: "Persistent memory, 17,000+ models, retrieval and threads, unlocked with promo code HTN2026. Pick how you want to build and you're set up in a minute."
...
5. **PickSection**, 64px top padding.
   ...
   Line under it, text-body, Text/Muted: "Enter promo code HTN2026 on the next step. You can switch paths later."
